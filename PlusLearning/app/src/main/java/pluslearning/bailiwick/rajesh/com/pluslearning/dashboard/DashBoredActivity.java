...
public class DashBoredActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   TextView mFaq,mNoticeBoard,mHome ,tv_referal;
   Toolbar mToolbar;
   ActionBar actionBar;
   ...
   int selectedPosition =1;
    ...
    public void getUiObject(){
        ...
        tv_referal.setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        Fragment f = this.getSupportFragmentManager().findFragmentById(R.id.frame_plearn);
        ...
        switch (v.getId()){
            ...
            case R.id.tv_notice_board:
                if (!(f instanceof NoticeFragment)){
    ...
    public void showProgress(){
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                Intent intent = new Intent(DashBoredActivity.this, LoginActivity.class);
